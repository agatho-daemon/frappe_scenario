...
SCALE_PROFILES: dict[str, dict[str, Any]] = {
	...
	"medium": {
		"description": "A realistic business with thousands of linked records over 12-24 months.",
		...
		"operations": {
			"sales_orders_per_month": 18,
			"purchase_orders_per_month": 8,
	...
	"large": {
		"description": "A large business with tens of thousands of records over 24-36 months.",
		...
		"operations": {
			"sales_orders_per_month": 90,
			"purchase_orders_per_month": 35,
	...
	return [
		{
			...
			"history_range": list(profile.get("history_range") or [profile["history_months"]] * 2),
